...
export default function JamieScreen5() {
  return (
    <div className="jamie-t5-content">
      ...
      {/* ── Status bar ── */}
      <div className="jamie-status-bar" aria-hidden="true">
        <span className="jamie-status-time">10:14</span>
        <div className="jamie-status-icons">
          <svg viewBox="0 0 24 24"><path d="M2 17h2v-7H2v7zm4 0h2V9H6v8zm4 0h2V5h-2v12zm4 0h2v-4h-2v4zm4 0h2v-9h-2v9z"/></svg>
