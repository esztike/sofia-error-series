...
_Sofia means wisdom in Greek._
...
- React Router
- MDX (@mdx-js/rollup)
- Radix UI (accordion, dialog, dropdown menu, tabs)
- Framer Motion
- Lucide React
- CSS - handwritten, token-based
...
- **Episode 1** — the full case study: Partial Completion, told through
  Maya, Sofia, and the people affected by what Sofia got wrong. Live now, with a working walkthrough of one failure, end to end

## Status

Episode 1 is published. Episodes 2 and 3 are planned.
